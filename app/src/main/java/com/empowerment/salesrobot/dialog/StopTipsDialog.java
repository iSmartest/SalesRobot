...
public class StopTipsDialog extends Dialog implements
    ...
    public StopTipsDialog(Context context, String tips, String cancel, String sure,
    ...
    public StopTipsDialog(Context context, int tips,
                          OnSureBtnClickListener sureListener) {
        super(context);
        this.mContext = context;
        this.mSureListener = sureListener;
